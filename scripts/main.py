...
# NB: Could have written this as a function
if not os.path.exists('../predictions'):
    os.mkdir("../predictions")
        
aggregate_data = classifier.get_features_from_csv("../stats_files/aggregated_stats.csv")
run_train_files = classifier.get_features_from_csv("../stats_files/train_stats.csv")
run_valid_files = classifier.get_features_from_csv("../stats_files/valid_stats.csv")
run_test_files = classifier.get_features_from_csv("../stats_files/test_stats.csv")
...
utils.create_csv(train_outputs, "../predictions/train_data_predictions.csv")
amount_files_tested, classified_correct, accuracy = classifier.determine_accuracy("../predictions/train_data_predictions.csv")
...
utils.create_csv(valid_outputs, "../predictions/validation_data_predictions.csv")
...
utils.create_csv(test_outputs, "../predictions/test_data_predictions.csv")    
amount_files_tested, classified_correct, accuracy = classifier.determine_accuracy("../predictions/test_data_predictions.csv")
print("Number of files processed:", amount_files_tested)
print("Number classified correct:", classified_correct)
print(f"Accuracy: {round(accuracy,2)}%")